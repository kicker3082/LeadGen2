        ...
        <tr>
            <td width="100%" height="100%" >
                <form name="loginform" method="POST" action="validate_new.asp" style="margin: 0px">
                    <input name="anlxlzbavalidxiaplisw" value="DT: 9/1/2019 4:54:49 AM" type="hidden">
                    <input name="Page_Loaded" value="DT: 9/1/2019 5:08:08 AM" type="hidden">
...
<footer class="mls-site-footer">
    <div class="footer-content">
        ...
        <div class="vert-bar">|</div>
        <div class="footer-user-count">51 users online right now!</div>
    </div>
</footer>
